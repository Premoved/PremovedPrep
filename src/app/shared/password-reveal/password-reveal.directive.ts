 ...
 * in some of these screens. Its styling lives in styles.css, because elements created here carry
...
export class PasswordRevealDirective implements OnInit, OnDestroy {
	...
	ngOnInit(): void {
		...
		/** Not a submit: these fields sit inside forms, and the default type would send them. */
		this.renderer.setAttribute(button, 'type', 'button');
		/** Off the tab order: it is a convenience, and a keyboard user tabbing from the field expects
		    to land on the submit button, not on this. */
	...
	private toggle(): void {
		...
		this.describe();
		/** The caret goes back where it was; changing type moves focus off the field in some browsers. */
		this.input.focus();
	}
